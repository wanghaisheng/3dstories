...
const GruenerWams = forwardRef(({ position, rotation, ...props }, ref) => {
  ...
  const { nodes, materials } = useGLTF('gruener_wams/.glb')
...
useGLTF.preload('/gruener_wams.glb')

export default GruenerWams
